...
<html>
  <head>
    ...
    <?php $this->load->view('templates/header-2');?>
  ...
  <body>
                    ...
                    <ul class="feed-elements list-unstyled">
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url(); ?>assets/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url(); ?>assets/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url(); ?>assets/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url(); ?>assets/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url(); ?>assets/img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
   ...
   <?php $this->load->view('templates/footer-2');?>
  </body>
</html>